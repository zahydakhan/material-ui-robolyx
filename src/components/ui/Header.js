...
import logo from "../../assets/robolyxlogo.svg";
...
export default function Header(props) {
  ...
  const menuOptions = [
    { name: "Solutions", link: "/solutions", activeIndex: 1, selectedIndex: 0 },
    {
  ...
  const routes = [
    ...
    { name: "Resources", link: "/resources", activeIndex: 2 },
    { name: "Company", link: "/company", activeIndex: 3 },
      ...
      <ElevationScroll>
        <AppBar position='fixed' color='primary' className={classes.appbar}>
          <Toolbar position='fixed'>
            ...
            <Typography className={classes.logoname} variant='h3'>
              Robolyx
            </Typography>
